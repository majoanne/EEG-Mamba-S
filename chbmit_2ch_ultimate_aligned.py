...
def main():
    ...
    parser.add_argument('--weights_path', type=str, default="/root/EEGMamba-main/multi_seed_best_seed_3407/epoch_50.pth")
    ...
    for seed in seeds:
        ...
        if os.path.exists(args.weights_path):
            model.load_state_dict(torch.load(args.weights_path, map_location='cpu'), strict=False)
